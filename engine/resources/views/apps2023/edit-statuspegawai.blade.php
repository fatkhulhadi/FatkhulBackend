...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Data Status Pegawai</h1>
          </div>
          <div class="col-sm-6">
              ...
              <form action="{{ route('statuspegawai.update', $statuspegawai->id) }}" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_statuspegawai" name="nama_statuspegawai" value="{{ $statuspegawai->nama_statuspegawai }}" required>
                  </div>
                </div>
                <!-- /.card-body -->
