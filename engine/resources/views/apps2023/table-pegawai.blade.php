                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $all->nama }}</td>
                      <td>{{ $all->nik }}</td>
                      <td>{{ $all->fjenispegawai->nama_jenispegawai }}</td>
                      <td>{{ $all->fstatuspegawai->nama_statuspegawai }}</td>
                      <td>{{ $all->unit }}</td>
                      <td>{{ $all->sub_unit }}</td>
                      <td>{{ $all->fpendidikan->nama_pendidikan }}</td>
                      <td>{{ $all->tgl_lahir }}</td>
                      <td>{{ $all->tmpt_lahir}}</td>
                      <td>{{ $all->fjeniskelamin->nama_jeniskelamin }}</td>
