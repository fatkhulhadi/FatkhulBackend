            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    @php $i = 0; @endphp
                    @foreach($jenispegawais as $all)
                    <tr>
                      <td>{{ ++$i }}</td>
                      <td>{{ $all->nama_jenispegawai }}</td>
                      <td>
                      <a href="{{ route('jenispegawai.edit', $all->id) }}" class="btn btn-warning">Edit</a>

                      <form onsubmit="return confirm('Apakah Anda yakin akan menghapus data @php $all->nama_jenispegawai @endphp?');"
